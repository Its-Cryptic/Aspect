...
public class ScanWorldEvent extends WorldEventInstance implements WorldEventType.EventInstanceSupplier {
    ...
    public ScanWorldEvent(Vec3 position, int radius, int duration) {
    ...
    public ScanWorldEvent() {
        super(AspectWorldEventTypes.LAVA);
    }

    @Override
    public WorldEventInstance getInstance() {
        return this;
    }
    ...
    public WorldEventInstance deserializeNBT(CompoundTag tag) {
        ScanWorldEvent scanWorldEvent = new ScanWorldEvent(
                new Vec3(tag.getDouble("x"), tag.getDouble("y"), tag.getDouble("z")),
                tag.getInt("radius"),
                tag.getInt("duration")
        );
        scanWorldEvent.tickCount = tag.getInt("tickCount");
        return scanWorldEvent;
    }
    ...
    public void tick(Level level) {
        ...
        if (level instanceof ClientLevel clientLevel) {
            ...
            Aspect.LOGGER.info(this.toString());
        }
